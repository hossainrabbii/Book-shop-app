...
import { IBook } from "../components/ABooks";
        ...
        <div className="flex flex-col w-full lg:w-80%  gap-8 ">
          <div className="flex gap-4 flex-col lg:flex-row ">
            <div className="w-full lg:w-[45%] p-6 border border-[#DDDDDD] rounded-lg max-h-[450px] lg:max-h-[550px] relative overflow-hidden bg-white">
              ...
              <img src={bookImg} alt="" className="w-[60%] lg:w-[85%] m-auto" />
            </div>
            <div className="w-full lg:w-[55%] border border-[#DDDDDD] rounded-lg p-6 bg-white">
              ...
              <div className="border-b py-4 border-[#DDDDDD]">
                <p>
                  {description} Cum ad et sint ut neque molestias. Illo possimus
                  eos quas alias. Recusandae omnis fugiat sequi. Nesciunt rem
                  perferendis consectetur rerum dolores.
                </p>
              </div>
              <div className="border-b py-4 border-[#DDDDDD]">
              ...
              >
                <Link to={`/book/${book._id}`}>
                  <img
                    src={bookImg}
                    alt="Book Image"
                    className="lg:h-[180px] m-auto"
                  />
                  <p className="text-sm">{book?.name}</p>
                  <p className="text-sm text-[#F65D4E]">TK. {book?.price}</p>
                </Link>
              </div>
            ))}
          </div>
